...
An example annotated source file can be found `here <https://github.com/xsuite/xfields/blob/master/xfields/src/linear_interpolators.h>`_ and the corresponding autogenerated source files for the three platforms can be found in `this folder <https://github.com/xsuite/xfields/tree/master/xfields/src_autogenerated>`_ .
