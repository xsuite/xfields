...
wfx_0.init_pipeline(pipeline_manager=pipeline_manager,element_name = 'wake', partners_names = ['b1'])
wfx_1 = xf.Wakefield(
    source_moments=['num_particles', 'x'],
    kick='px',
    scale_kick=None,
...
wfx_1.init_pipeline(pipeline_manager=pipeline_manager,element_name = 'wake', partners_names = ['b0'])
...
#print('IDs',pipeline_manager._IDs)
#print('Elements',pipeline_manager._elements)
print('Tracking')
