...
void UniformBinSlicer_slice(UniformBinSlicerData el,
    ...
    //start_per_particle_block (part0->part)
        ...
        if (can_be_assigned_to_slice && i_slice >= 0 && i_slice < num_slices){
            ...
            // for mm in moms:
            //     cc1, cc2 = mm.split('_')
            //     print(f"atomicAdd(&sum_{mm}[i_slice + i_bunch * num_slices], weight * LocalParticle_get_{cc1}(part) * LocalParticle_get_{cc2}(part));")

            atomicAdd(&sum_x_x[i_slice + i_bunch * num_slices], weight * LocalParticle_get_x(part) * LocalParticle_get_x(part));
            atomicAdd(&sum_x_px[i_slice + i_bunch * num_slices], weight * LocalParticle_get_x(part) * LocalParticle_get_px(part));
            atomicAdd(&sum_x_y[i_slice + i_bunch * num_slices], weight * LocalParticle_get_x(part) * LocalParticle_get_y(part));
            atomicAdd(&sum_x_py[i_slice + i_bunch * num_slices], weight * LocalParticle_get_x(part) * LocalParticle_get_py(part));
            atomicAdd(&sum_x_zeta[i_slice + i_bunch * num_slices], weight * LocalParticle_get_x(part) * LocalParticle_get_zeta(part));
            atomicAdd(&sum_x_delta[i_slice + i_bunch * num_slices], weight * LocalParticle_get_x(part) * LocalParticle_get_delta(part));
            atomicAdd(&sum_px_px[i_slice + i_bunch * num_slices], weight * LocalParticle_get_px(part) * LocalParticle_get_px(part));
            atomicAdd(&sum_px_y[i_slice + i_bunch * num_slices], weight * LocalParticle_get_px(part) * LocalParticle_get_y(part));
            atomicAdd(&sum_px_py[i_slice + i_bunch * num_slices], weight * LocalParticle_get_px(part) * LocalParticle_get_py(part));
            atomicAdd(&sum_px_zeta[i_slice + i_bunch * num_slices], weight * LocalParticle_get_px(part) * LocalParticle_get_zeta(part));
            atomicAdd(&sum_px_delta[i_slice + i_bunch * num_slices], weight * LocalParticle_get_px(part) * LocalParticle_get_delta(part));
            atomicAdd(&sum_y_y[i_slice + i_bunch * num_slices], weight * LocalParticle_get_y(part) * LocalParticle_get_y(part));
            atomicAdd(&sum_y_py[i_slice + i_bunch * num_slices], weight * LocalParticle_get_y(part) * LocalParticle_get_py(part));
            atomicAdd(&sum_y_zeta[i_slice + i_bunch * num_slices], weight * LocalParticle_get_y(part) * LocalParticle_get_zeta(part));
            atomicAdd(&sum_y_delta[i_slice + i_bunch * num_slices], weight * LocalParticle_get_y(part) * LocalParticle_get_delta(part));
            atomicAdd(&sum_py_py[i_slice + i_bunch * num_slices], weight * LocalParticle_get_py(part) * LocalParticle_get_py(part));
            atomicAdd(&sum_py_zeta[i_slice + i_bunch * num_slices], weight * LocalParticle_get_py(part) * LocalParticle_get_zeta(part));
            atomicAdd(&sum_py_delta[i_slice + i_bunch * num_slices], weight * LocalParticle_get_py(part) * LocalParticle_get_delta(part));
            atomicAdd(&sum_zeta_zeta[i_slice + i_bunch * num_slices], weight * LocalParticle_get_zeta(part) * LocalParticle_get_zeta(part));
            atomicAdd(&sum_zeta_delta[i_slice + i_bunch * num_slices], weight * LocalParticle_get_zeta(part) * LocalParticle_get_delta(part));
