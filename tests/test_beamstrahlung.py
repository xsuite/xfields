...
def test_beambeam3d_beamstrahlung_ws_no_config():
    for context in xo.context.get_test_contexts():
        ...
        if isinstance(context, xo.ContextCupy):
            print(f"[test.py] default_blocksize: {context.default_block_size}")
        ...
        ###################################################
        el_beambeam_b1.slices_other_beam_sqrtSigma_11_beamstrahlung = context.nplike_lib.array(n_slices*[sigma_x])
        el_beambeam_b1.slices_other_beam_sqrtSigma_33_beamstrahlung = context.nplike_lib.array(n_slices*[sigma_y]) 
        el_beambeam_b1.slices_other_beam_sqrtSigma_55_beamstrahlung = context.nplike_lib.array(slicer.bin_weights) * sigma_z_tot 
...
def test_beambeam3d_beamstrahlung_ws_config():
    for context in xo.context.get_test_contexts():
...
def test_beambeam3d_beamstrahlung_qss():
    for context in xo.context.get_test_contexts():
        ...
        bbeamIP1_b1.slices_other_beam_sqrtSigma_11_beamstrahlung = context.nplike_lib.array(n_slices*[sigma_x])
        bbeamIP1_b1.slices_other_beam_sqrtSigma_33_beamstrahlung = context.nplike_lib.array(n_slices*[sigma_y])
        bbeamIP1_b1.slices_other_beam_sqrtSigma_55_beamstrahlung = context.nplike_lib.array(slicer.bin_weights) * sigma_z_tot

        bbeamIP1_b2.slices_other_beam_sqrtSigma_11_beamstrahlung = context.nplike_lib.array(n_slices*[sigma_x])
        bbeamIP1_b2.slices_other_beam_sqrtSigma_33_beamstrahlung = context.nplike_lib.array(n_slices*[sigma_y]) 
        bbeamIP1_b2.slices_other_beam_sqrtSigma_55_beamstrahlung = context.nplike_lib.array(slicer.bin_weights) * sigma_z_tot 
...
def test_beambeam3d_beamstrahlung_ss():
    for context in xo.context.get_test_contexts():
