...
def test_iptocp_strongstrong(test_context):
    ...
    for phi in phi_arr:
        ...
        slicer = xf.TempSlicer(_context=context, n_slices=1, sigma_z=sigma_z, mode="unicharge")
        ...
        bbeamIP1_b2 = xf.BeamBeamBiGaussian3D(
                    ...
                    phi = 0, # boost beam 1 slices by -phi
                    alpha=0, 
                    config_for_update = config_for_update_b2_IP1,
        )
