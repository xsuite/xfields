...
interpolated_wake_0 = particles_1.x[ioffset]*np.interp(particles_0.zeta,-1E-9*np.flip(wake_data[:,0])*c,-1E15*scaling_constant*np.flip(wake_data[:,iwake_component]))
interpolated_wake_1 = particles_1.x[ioffset]*np.interp(particles_1.zeta,-1E-9*np.flip(wake_data[:,0])*c,-1E15*scaling_constant*np.flip(wake_data[:,iwake_component]))
