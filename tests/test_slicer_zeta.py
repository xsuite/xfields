...
slicer_0 = xf.UniformBinSlicer(zeta_range=zeta_range, num_slices=num_slices)
slicer_1 = xf.UniformBinSlicer(zeta_range=zeta_range, dzeta=dzeta)
slicer_2 = xf.UniformBinSlicer(zeta_slice_edges=zeta_slice_edges)
