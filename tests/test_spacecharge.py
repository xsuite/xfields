...
def test_spacecharge_gauss_qgauss(test_context, frozen):
    #################################
...
@for_all_test_contexts(excluding='ContextPyopencl')  # pyocl core dumps on this
@pytest.mark.parametrize(
    'solver',
    ['FFTSolver2p5D', 'FFTSolver3D'],
)
def test_spacecharge_pic(test_context, solver):
    #################################
    # Generate particles and probes #
    #################################
