...
class BeamBeamBiGaussian3DBase(xt.BeamElement):
...
srcs.append(_pkg_root.joinpath('beam_elements/beambeam_src/beambeam3d_base.h'))

BeamBeamBiGaussian3DBase.XoStruct.extra_sources = srcs
