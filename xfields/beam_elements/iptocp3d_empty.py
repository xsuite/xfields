...
class IPToCP3D_empty(xt.BeamElement):
...
srcs.append(_pkg_root.joinpath('beam_elements/beambeam_src/iptocp3d_empty.h'))

IPToCP3D_empty.XoStruct.extra_sources = srcs
