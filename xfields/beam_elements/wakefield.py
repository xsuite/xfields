...
class Wakefield(ElementWithSlicer):
    ...
    @classmethod
    def from_table(cls, df, use_components, beta0=1.0, flag_pyht_units=False,
                   **kwargs):
        ...
        wake_distance = conversion_factor_time * df['time'] * beta0 * clight
        components = []
        for component in list(df.keys()):
            if component != 'time' and (use_components is None or
                ...
                wake_strength = conversion_factor * df[component]
