...
pyopencl_default_kernels = {
    ...
    'src_files': [
        pkg_root.joinpath('src_autogenerated/linear_interpolators_opencl.clh')
        ]
    }
...
cpu_default_kernels = {
    'kernel_descriptions': shared_kernel_descriptions,
    'src_files': [
        pkg_root.joinpath('src/atomicadd.h'),
        pkg_root.joinpath('src_autogenerated/linear_interpolators_cpu_serial.c')
        ]
    }
