...
void synchrobeam_kick(
    ...
    printf("The Fx value is %.9lf.\n", *Fx_star)
    printf("The Fy value is %.9lf.\n", *Fy_star)
    ...
    scanf("%lf", & *px_star);
    scanf("%lf.", & *py_star);
    printf("The x value before kick is %.9lf.\n", *x_star);
    printf("The y value before kick is %.9lf.\n", *y_star);
    printf("The px value before kick is %.9lf.\n", *px_star);
    printf("The py value before kick is %.9lf.\n", *py_star);
    ...
    *py_star = *py_star + Fy_star;
    ...
    scanf("%lf", &*px_star);
    scanf("%lf.", &*py_star);
    printf("The x value after kick is %.9lf.\n", *x_star);
    printf("The y value after kick is %.9lf.\n", *y_star);
    printf("The px value after kick is %.9lf.\n", *px_star);
    printf("The py value after kick is %.9lf.\n", *py_star);
}
