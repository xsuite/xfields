...
void synchrobeam_kick(
    ...
    scanf("%lf", & *px_star);
    scanf("%lf.", & *py_star);
    printf("The x value before kick is %lf", *x_star);
    printf("The y value before kick is %lf", *y_star);
    printf("The px value before kick is %lf", *px_star);
    printf("The py value before kick is %lf", *py_star);
    ...
    *py_star = *py_star + Fy_star;
    ...
    scanf("%lf", &*px_star);
    scanf("%lf.", &*py_star);
    printf("The x value after kick is %lf", *x_star);
    printf("The y value after kick is %lf", *y_star);
    printf("The px value after kick is %lf", *px_star);
    printf("The py value after kick is %lf", *py_star);
}
